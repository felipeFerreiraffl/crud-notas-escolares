...
export default function ProfWelcome({ name }) {
  return (
    <LinearGradient
      style={styles.container}
      colors={[ntColors.ntBlueDark, ntColors.ntBlueQua]}
      start={{ x: 0, y: 1 }}
      end={{ x: 0, y: 0 }}
    >
      <View style={styles.textContent}>
        <Text style={styles.textWelcome}>Bem vindo, {name}</Text>
        <Text style={styles.textExplanation}>Aqui você poderá ver as notas dos seus alunos, além de verificar outras informações</Text>
      </View>
      <Image
        style={styles.image}
        source={require('../../assets/images/welcome-prof.png')}
      />
    </LinearGradient>
  );
}
